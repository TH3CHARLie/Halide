...
APPS = "bgu bilateral_grid camera_pipe conv_layer hist iir_blur interpolate lens_blur local_laplacian max_filter nl_means".split()
...
OUTPUT = "/home/xuanda/dev/Halide/paper_scripts/new_plots"
...
if __name__ == "__main__":
    for app in APPS:
        ...
        predictions = os.path.join(app_dir, latest_autotune_dir, "predictions_new")
